...
const MouseEvents = () => {
  const [ coordX, setCoordX] = useState("");//hook yapisi ,arrayi parcalayip setcoordX tanimlamasi yapti. asagidaki kodla icerigini doldurup coordx e atadi. bunu da daha sonra span icinde kullandik.
